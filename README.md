...
<a href="https://github.com/coltdorsey/jirafy-sync/releases/tag/v2.0.0"><img alt="Jirafy Sync Release v2.0.0" src="./jsync_release.png" width="800"></a>

<a href="https://github.com/coltdorsey/jirafy-sync/releases/tag/v2.0.0"><img alt="Jirafy Sync Release Detail v2.0.0" src="./jsync_release_detail.png" width="800"></a>

### Updates Jira ticket(s) fixVersion property
<a href="https://github.com/coltdorsey/jirafy-sync/releases/tag/v2.0.0"><img alt="Jirafy Sync fixVersion v2.0.0" src="./jsync_fixVersion.png" width="800"></a>
